...
def viewer(selfimgdir, kind=Toplevel, cols=None):
    win = kind()
    win.title('Viewer: ' + imgdir)
    quit = Button(win, text='Quit', command=win.quit, bg='magenta')
...
if __name__ == '__main__':
     imgdir = (len(sys.argv) > 1 and sys.argv[1]) or '..//pythonProject//'
